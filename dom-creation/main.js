...
function renderPokemon(pokemon) {
  ...
  const h2Text = document.createTextNode(pokemon.name);
  h2.appendChild(h2Text);
  const h3 = document.createElement('h3');
  thirdDiv.appendChild(h3);
  const h3Text = document.createTextNode(pokemon.number);
  h3.appendChild(h3Text);
  const paragraph = document.createElement('p');
  thirdDiv.appendChild(paragraph);
  const pText = document.createTextNode(pokemon.description);
